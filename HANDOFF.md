...
阶段：离职前后求职冲刺 + 银行 Java / 自研 Java 岗位准备。
...
- 已新增 `java-ai-agent-interview-question-bank-2026.md` 作为离线冲刺题库，覆盖 Java、Spring、MySQL、Redis、MQ、系统设计、AI Agent/RAG/Tool Calling 和用户项目专项题；后续冲刺复习优先使用该文件。
...
- 下份工作硬性偏好：如果存在加班，需要有明确加班费或等价补偿；岗位最好能带来技术成长和更完整的项目经验。
...
- 后续优先梳理并接管 `interview-assistant`，重点从“能跑的前后端项目”变成“能讲清 MVC 主流程、核心代码和 AI 辅助边界”。
- 2026-06-21 已从 GitHub 拉取 `BQHM/interview-assistant` 最新源码并完成第一版项目卡片。
- 2026-06-21 已根据用户提供的 AI Agent 工程师 JD，新增岗位适配学习路线。
- 2026-06-21 用户补充真实工作经历：2024-04 入职长亮科技存款组做 Java 开发，2026-06-01 起在宁波银行驻场参与数币业务。
